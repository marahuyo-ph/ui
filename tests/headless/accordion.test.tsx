...
import * as Accordion from '#registry/headless/accordion';
...
describe('given a single Accordion', () => {
  ...
  describe('with default orientation=vertical', () => {
    ...
    describe.todo('when navigating by keyboard', () => {
      beforeEach(() => {
    ...
    describe.todo('when clicking a trigger', () => {
  ...
  describe.todo('with orientation=horizontal', () => {
...
describe.todo('given a multiple Accordion', () => {
  let handleValueChange: Mock;
  let rendered: RenderResult;
